export default function SectionSobreNosotros(props) {
  return (
    <section id='quienes-somos' className="relative w-full h-screen flex flex-col items-center justify-start md:flex-row md:items-stretch">
        <div className="absolute inset-0 z-0 bg-cover bg-center md:bg-[length:50%] md:bg-right md:bg-no-repeat" style={{ backgroundImage: "url('/public/fondo-quienes.jpg')" }}>
            <div className="absolute inset-0 bg-black/35 pointer-events-none"></div>
        </div>

        <img src="/public/logo-quienes.png" alt="Logo mobile" className="relative z-10 h-16 mt-4 md:hidden"/>
        ...
        <div className="relative z-10 flex flex-col items-center pt-4 md:pt-0 md:justify-center w-full md:w-[60rem] bg-transparent md:bg-[#e37b00]">
            ...
            <img src="/public/logo-quienes.png" alt="Logo desktop" className="hidden md:block  h-16 object-contain"/>
