...
export default function Item({ title, img, precios, prod, preciosExtras }) {
  ...
  const opcionesPermitidas = [
    {
      permitido: prod.extrasPermitidos.glaseado,
      estado: glaseado,
      setEstado: setGlaseado,
      etiqueta: `Glaseado (+$${extraGlaseado})`,
      nombre: "glaseado",
    },
    {
      permitido: prod.extrasPermitidos.chips,
      estado: chips,
      setEstado: setChips,
      etiqueta: `Chips (+$${extraChips})`,
      nombre: "chips",
    },
    {
      permitido: prod.extrasPermitidos.nueces,
      estado: nueces,
      setEstado: setNueces,
      etiqueta: `Nueces (+$${extraNueces})`,
      nombre: "nueces",
    },
  ];
  //#endregion
